...
public class BaseUserManager : MonoBehaviour {
	// gameplay specific data we keep these private and provide methods to modify them instead, just to prevent any accidental corruption or invalid data coming in
	private int score;
